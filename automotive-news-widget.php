...
Version: 0.5
Author: Scott Faisal
Author URI: http://2levelsabove.com/
*/
...
function automotive_news_widget_init() {
	...
	function automotive_news_widget($args) {
		...
		<p class='automotive-news-badge'><a target="_blank" href="http://alltherides.com" title="Free Car Classifieds"><img src="<?php echo $badge; ?>" alt="Free Car Classifieds" title="Free Car Classifieds" border="0"  /></a></p>
